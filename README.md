...
## Challenge-303 list:
  ...
  - 000 - Calculate area of rectangle - User can entered a values from keyboard
  - 001 - Mod division of two values- User can entered a values from keyboard
  ...
  - 005 - Using for loop, while and do while - pring numbers from 0 to 50. In while loop put sum of numbers from this loop.
